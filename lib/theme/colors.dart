...
class AppColors {
  // Brand — warm amber/brown, matches AppTextStyles.heading1.
  static const Color primary = Color(0xFF5C4033);
  static const Color primaryLight = Color(0xFF8A6B5C);
  static const Color primaryDark = Color(0xFF7A4B0A);

  // Secondary accent — deep leather brown, for contrast against the amber.
  static const Color secondary = Color(0xFFAB6B11);
  static const Color secondaryLight = Color(0xFFD18B3A);
  ...
  static const Color textSecondaryDark = Color(0xFFC9BDAE);
